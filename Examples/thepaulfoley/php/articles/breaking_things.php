...
<br>
<br>
<img src=<?php echo $toRoot."img/breaking_things/arp1.bmp"?> width="509px" height="350px" style="display:block; margin-left:auto; margin-right:auto;" />
<br>
<br>
...
<br>
<br>
<img src=<?php echo $toRoot."img/breaking_things/arp2.bmp"?> width="539px" height="350px" style="display:block; margin-left:auto; margin-right:auto;" />
<br>
<br>
...
<br>
<br>
<img src=<?php echo $toRoot."img/breaking_things/arp3.bmp"?> width="509px" height="401px" style="display:block; margin-left:auto; margin-right:auto;" />
<br>
<br>
...
<br>
<br>
<img src=<?php echo $toRoot."img/breaking_things/arp4.bmp"?> width="509px" height="350px" style="display:block; margin-left:auto; margin-right:auto;" />
<br>
<br>
<div>Once again, 10.1.1.32 will send out a "who has" request.</div>
<br>
<br>
<img src=<?php echo $toRoot."img/breaking_things/arp5.bmp"?> width="539px" height="350px" style="display:block; margin-left:auto; margin-right:auto;" />
<br>
<br>
...
<br>
<br>
<img src=<?php echo $toRoot."img/breaking_things/arp6.bmp"?> width="605px" height="350px" style="display:block; margin-left:auto; margin-right:auto;" />
<br>
<br>
...
<br>
<br>
<img src=<?php echo $toRoot."img/breaking_things/arp7.bmp"?> width="509px" height="350px" style="display:block; margin-left:auto; margin-right:auto;" />
<br>
<br>
...
<br>
<br>
<img src=<?php echo $toRoot."img/breaking_things/smurf1.bmp"?> width="363px" height="237px" style="display:block; margin-left:auto; margin-right:auto;" />
<br>
<br>
<div>First, we see the attacker sending the ICMP reply requests to the broadcast addresses.</div>
<br>
<br>
<img src=<?php echo $toRoot."img/breaking_things/smurf2.bmp"?> width="363px" height="302px" style="display:block; margin-left:auto; margin-right:auto;" />
<br>
<br>
<div>Then, we see all the replies being directed at the target.</div>
<br>
<br>
<img src=<?php echo $toRoot."img/breaking_things/smurf3.bmp"?> width="363px" height="237px" style="display:block; margin-left:auto; margin-right:auto;" />
<br>
<br>
...
<br>
<br>
<img src=<?php echo $toRoot."img/breaking_things/syn1.bmp"?> width="267px" height="62px" style="display:block; margin-left:auto; margin-right:auto;" />
<br>
<br>
...
<br>
<br>
<img src=<?php echo $toRoot."img/breaking_things/syn2.bmp"?> width="278px" height="94px" style="display:block; margin-left:auto; margin-right:auto;" />
<br>
<br>
<div>Finally, the first host sends an ACK packet. This is like saying, "Cool, see you at 8:00pm.".</div>
<br>
<br>
<img src=<?php echo $toRoot."img/breaking_things/syn3.bmp"?> width="278px" height="117px" style="display:block; margin-left:auto; margin-right:auto;" />
<br>
<br>
...
<br>
<br>
<img src=<?php echo $toRoot."img/breaking_things/syn4.bmp"?> width="325px" height="256px" style="display:block; margin-left:auto; margin-right:auto;" />
<br>
<br>
...
<br>
<br>
<img src=<?php echo $toRoot."img/breaking_things/syn5.bmp"?> width="364px" height="256px" style="display:block; margin-left:auto; margin-right:auto;" />
<br>
<br>
...
<br>
<br>
<img src=<?php echo $toRoot."img/breaking_things/syn6.bmp"?> width="412px" height="256px" style="display:block; margin-left:auto; margin-right:auto;" />
<br>
<br>
...
<br>
<br>
<img src=<?php echo $toRoot."img/breaking_things/sql1.bmp"?> width="442px" height="245px" style="display:block; margin-left:auto; margin-right:auto;" />
<br>
<br>
<div>Next, we enter a valid username and password.</div>
<br>
<br>
<img src=<?php echo $toRoot."img/breaking_things/sql2.bmp"?> width="451px" height="258px" style="display:block; margin-left:auto; margin-right:auto;" />
<br>
<br>
<div>Upon clicking the "Log In" button, we are greeted by a friendly although slightly exaggerated welcome screen.</div>
<br>
<br>
<img src=<?php echo $toRoot."img/breaking_things/sql3.bmp"?> width="626px" height="249px" style="display:block; margin-left:auto; margin-right:auto;" />
<br>
<br>
...
<br>
<br>
<img src=<?php echo $toRoot."img/breaking_things/sql4.bmp"?> width="433px" height="280px" style="display:block; margin-left:auto; margin-right:auto;" />
<br>
<br>
