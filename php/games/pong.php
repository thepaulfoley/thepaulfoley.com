...
<div id="pongGameDiv" class="gameDiv">
<APPLET CODE="test.class" CODEBASE=<?php echo $toRoot."games/Pong/bin/" ?> WIDTH=400
	HEIGHT=300>This game was created with a Java Applet. Your browser does not support Applets.</APPLET>
</div>
</div>
